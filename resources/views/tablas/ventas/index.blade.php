...
<nav class="navbar float-right">
    <form class="form-inline my-2 my-lg-0">
        <input class="form-control mr-sm-2" type="search" placeholder="Buscar por codigo" aria-label="Search" id="buscarpor" name="buscarpor" value={{$buscarpor}} >
